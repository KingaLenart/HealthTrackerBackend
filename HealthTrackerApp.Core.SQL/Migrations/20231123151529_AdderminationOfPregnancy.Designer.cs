...
namespace HealthTrackerApp.Core.SQL.Migrations
{
    ...
    [Migration("20231123151529_AdderminationOfPregnancy")]
    partial class AdderminationOfPregnancy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HealthTrackerApp.Core.Models.Pregnancies.PregnancyEntity", b =>
                {
                    ...
                    b.Property<bool?>("TerminationOfPregnancy")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("TerminationOfPregnancyDate")
                        .HasColumnType("datetime2");
